...
//        System.out.println(new Solution(4));
        ...
        try {
            ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("D:\\JAVA\\RUSH\\File1.txt"));
            outputStream.writeObject(savedObject);
            outputStream.close();
            ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream("D:\\JAVA\\RUSH\\File1.txt"));
