package com.itacademy.javacore.homeWork.homeWork12.task2;
...
//Запустить 4 потока, каждый из которых добавляет свое имя к результирующей строке
//        и выводит ее в синхронизированном с помощью ReentrantLock коде.
//        Сделать так, чтобы потоки выполнялись по очереди в порядке возрастания
//        номера потока при помощи Condition этого Lock
//        (создать массив Condition по одному для каждого потока, каждый поток будет ждать свое условие,
//        а предыдущий по номеру поток будет сигнализировать об условии).
//        Пример работы с Lock и Condition SynchBankTestLock.java в проекте threads.
public class Main {
    public static void main(String[] args) {
        // Конструктор класса принимает количество потоков и создает их автоматически.
