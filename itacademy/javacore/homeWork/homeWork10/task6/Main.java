...
//( * - необ€зательна€ задача) ѕрочитать текст Java-программы,
//        удалить из него все виды комментариев (// и /* */), все слова public в
//// объ€влении атрибутов и методов класса заменить на слово private.
public class Main {
    public static void main(String[] args) {

        // ¬ File.txt - подопытный текст. копируетс€ File1.txt дл€ проверки.
