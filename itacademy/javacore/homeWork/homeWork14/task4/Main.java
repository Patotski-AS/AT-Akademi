package com.itacademy.javacore.homeWork.homeWork14.task4;
...
//Создать стрим из 50 случайных чисел со значениями от 0 до 20 (используя Stream.generate),
//        вывести его  и сохранить его в переменную.
//        Затем подсчитать и вывести сумму элементов в стриме,
//        количество элементов в стриме, минимальный и максимальный элементы.
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Сумма всех элементов: " + list.stream().reduce(0, Integer::sum));
